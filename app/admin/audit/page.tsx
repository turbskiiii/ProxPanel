    ...
    const fetchAuditLogs = async () => {
      ...
      const mockLogs: AuditLog[] = [
        ...
        },
        {
          ...
          details:
            'Created VPS instance "web-server-01" with 4GB RAM, 2 CPU cores',
          resourceId: 'vm-100',
          resourceType: 'vps',
        },
        {
        ...
        },
        {
          ...
          details:
            'Payment of $89.99 processed successfully for invoice INV-2024-001',
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              {statusStats.success} successful events
            </p>
          </CardContent>
        </Card>
