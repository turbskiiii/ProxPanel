    ...
    return (
      <div className='space-y-6'>
        ...
        <Alert variant='destructive'>
          ...
          <AlertDescription>
            VPS instance not found or failed to load.
          </AlertDescription>
        </Alert>
      </div>
    );
    ...
    <div className='space-y-6'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {vps.network.inbound + vps.network.outbound} Mbps
            </div>
      ...
      >
        <TabsList>
          ...
          <TabsTrigger value='os'>OS & SSH</TabsTrigger>
          ...
          <div className='grid gap-6 md:grid-cols-2'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Detailed system specifications and status
                </CardDescription>
              </CardHeader>
                ...
                <div className='grid grid-cols-2 gap-4 text-sm'>
                  ...
                  <div>
                    ...
                    <p className='font-medium'>
                      {new Date(vps.specs.lastReboot).toLocaleDateString()}
                    </p>
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Control your VPS power state and operations
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='grid gap-3'>
                  <Button
                    ...
                    disabled={
                      vps.status === 'running' || actionLoading !== null
                    }
                ...
                <div className='space-y-2 text-sm'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='font-medium font-mono'>
                      {vps.performance.loadAverage.join(', ')}
                    </span>
                  </div>
                  <div className='flex justify-between'>
        ...
        <TabsContent value='security' className='space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Security settings and status for your VPS
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='grid gap-4 md:grid-cols-2'>
                <div className='space-y-3'>
                  <div className='flex items-center justify-between'>
                    ...
                    <Badge
                      variant={
                        vps.security.firewall ? 'default' : 'destructive'
                      }
                    >
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Badge
                      variant={
                        vps.security.ddosProtection ? 'default' : 'destructive'
                      }
                    >
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Badge variant='outline'>
                      {vps.security.sslCerts} installed
                    </Badge>
                  </div>
                </div>
                <div className='space-y-3'>
                  <div className='flex items-center justify-between'>
                    ...
                    <Badge
                      variant={
                        vps.security.vulnerabilities === 0
                          ? 'default'
                          : 'destructive'
                      }
                    >
        ...
        <TabsContent value='console'>
          <VNCConsole vpsId={vps.id} node={vps.node} vmid={vps.vmid} />
        </TabsContent>
      </Tabs>
    </div>
  );
