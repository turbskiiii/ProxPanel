...
export const metadata: Metadata = {
  ...
  keywords: ["VPS", "Proxmox", "Server Management", "Cloud Infrastructure", "Dashboard"],
  ...
  openGraph: {
    title: "ProxPanel - Professional VPS Management",
    description: "Modern web-based dashboard for managing Proxmox VE virtual private servers",
    type: "website",
    locale: "en_US",
    siteName: "ProxPanel",
  },
