    ...
    <div className='space-y-6'>
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              {vps.backups.count} backups available
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {new Date(vps.backups.lastBackup).toLocaleDateString()}
            </div>
            <p className='text-xs text-muted-foreground'>
              {new Date(vps.backups.lastBackup).toLocaleTimeString()}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              Across {vps.backups.count} backups
            </p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure automatic backup settings for your VPS
          </CardDescription>
        </CardHeader>
          ...
          <div className='flex items-center justify-between'>
            <div className='space-y-0.5'>
              ...
              <p className='text-sm text-muted-foreground'>
                Enable scheduled automatic backups of your VPS
              </p>
            </div>
            <Switch
              id='backup-enabled'
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create an immediate backup of your VPS
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View and manage your backup snapshots
          </CardDescription>
        </CardHeader>
        <CardContent>
