    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{vps.monitoring.availability}%</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{vps.monitoring.responseTime}ms</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{vps.performance.networkLatency}ms</div>
            <p className="text-xs text-muted-foreground">To nearest datacenter</p>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Badge variant={vps.monitoring.checks.http ? "default" : "destructive"}>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Badge variant={vps.monitoring.checks.ping ? "default" : "destructive"}>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Badge variant={vps.monitoring.checks.ssh ? "default" : "destructive"}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Latest monitoring alerts and system events</CardDescription>
        </CardHeader>
        <CardContent>
