    ...
    <div className='space-y-6'>
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {vps.monthlyBandwidth.used} TB
            </div>
            <p className='text-xs text-muted-foreground'>
              of {vps.monthlyBandwidth.total} TB (
              {(
                (vps.monthlyBandwidth.used / vps.monthlyBandwidth.total) *
                100
              ).toFixed(1)}
              %)
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {(vps.network.inbound + vps.network.outbound).toFixed(1)} Mbps
            </div>
            <p className='text-xs text-muted-foreground'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {(vps.network.totalIn + vps.network.totalOut).toFixed(1)} TB
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {(
                (vps.network.packets.in + vps.network.packets.out) /
                1000000
              ).toFixed(1)}
              M
            </div>
        ...
        <TabsContent value='interfaces' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure your VPS network interfaces and IP addresses
              </CardDescription>
            </CardHeader>
                  ...
                  <div>
                    ...
                    <div className='flex gap-2'>
                      ...
                      <Button
                        variant='outline'
                        size='icon'
                        onClick={() => copyToClipboard(vps.ip, 'ipv4')}
                      >
                        {copied === 'ipv4' ? (
                    ...
                    <div className='md:col-span-2'>
                      ...
                      <div className='flex gap-2'>
                        ...
                        <Button
                          variant='outline'
                          size='icon'
                          onClick={() => copyToClipboard(vps.ipv6!, 'ipv6')}
                        >
                          {copied === 'ipv6' ? (
                            <CheckCircle className='h-4 w-4 text-green-600' />
                          ) : (
        ...
        <TabsContent value='firewall' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage inbound and outbound traffic rules
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              ...
              <div className='border rounded-lg'>
                ...
                {firewallRules.map(rule => (
                  <div
                    key={rule.id}
                    className='grid grid-cols-6 gap-4 p-3 border-b last:border-b-0 text-sm'
                  >
        ...
        <TabsContent value='dns' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure DNS servers and domain settings
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                <div className='p-4 border rounded-lg'>
                  ...
                  <div className='text-2xl font-bold text-green-600'>
                    {vps.network.inbound} Mbps
                  </div>
                  <p className='text-sm text-muted-foreground'>
                    {vps.network.packets.in.toLocaleString()} packets/sec
                  </p>
                </div>
                <div className='p-4 border rounded-lg'>
                  <h4 className='font-medium mb-2'>Outbound Traffic</h4>
                  <div className='text-2xl font-bold text-blue-600'>
                    {vps.network.outbound} Mbps
                  </div>
                  <p className='text-sm text-muted-foreground'>
