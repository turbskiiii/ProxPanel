            ...
            <AlertDescription>
              <div className='space-y-1'>
                ...
                <p className='text-sm text-green-700'>
                  Your VPS has been successfully reinstalled with the selected
                  operating system. A new root password has been generated and
                  sent to your email.
                </p>
              </div>
            </AlertDescription>
        ...
        <div className='space-y-3'>
          <div>
            <label className='text-sm font-medium mb-2 block'>
              Current OS:{' '}
              <span className='text-muted-foreground'>{vps.os}</span>
            </label>
          ...
          <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
            <DialogTrigger asChild>
              <Button
                variant='destructive'
                className='w-full'
                disabled={!selectedOS || isReinstalling}
              >
                {isReinstalling ? (
                  <>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This action will completely wipe your VPS and install a fresh
                  operating system.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className='space-y-4'>
                  ...
                  <AlertDescription>
                    <div className='space-y-2'>
                      ...
                      <ul className='text-sm space-y-1 ml-4 list-disc'>
                        ...
                        <li>
                          All installed software and configurations will be lost
                        </li>
                ...
                <div className='p-3 bg-muted rounded'>
                  <p className='text-sm'>
                    ...
                    <br />
                    <strong>New OS:</strong>{' '}
                    {availableOS.find(os => os.value === selectedOS)?.label}
                  </p>
                </div>
              </div>
